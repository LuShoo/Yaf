var UIJQueryUI = function () {
    ...
    var handleDatePickers = function () {
        ...
        $("#ui_date_picker_from" ).datepicker({
			dateFormat: 'yy-mm-dd',
		...
		//紫阳修改，用来只显示月份，2015-05-05

		$("#ui_date_picker_from_month" ).datepicker({
			dateFormat: 'yy-mm',
			monthNamesShort: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
			dayNamesMin: ["周日", "周一", "周二", "周三", "周四", "周五", "周六"],
			changeMonth: true,
		...
		$("#ui_date_picker_to_month" ).datepicker({
			dateFormat: 'yy-mm',
			monthNamesShort: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
			dayNamesMin: ["周日", "周一", "周二", "周三", "周四", "周五", "周六"],
			changeMonth: true,
