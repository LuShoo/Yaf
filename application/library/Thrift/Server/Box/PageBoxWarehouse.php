...
class PageBoxWarehouse {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Thrift\Server\Box\Equipment();
              $xfer += $elem12->read($input);
              $this->equipment []= $elem12;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PageBoxWarehouse');
    if ($this->equipment !== null) {
      ...
      $xfer += $output->writeFieldBegin('equipment', TType::LST, 1);
      {
        ...
        {
          foreach ($this->equipment as $iter13)
          {
