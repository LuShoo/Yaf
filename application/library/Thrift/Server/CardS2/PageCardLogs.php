...
class PageCardLogs {
  ...
  /**
   * @var \Thrift\Server\CardS2\CardLog[]
   */
  public $cardLog = null;
  /**
   * @var int
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Thrift\Server\CardS2\CardLog',
            ),
          ),
        2 => array(
          'var' => 'totalPage',
    ...
    if (is_array($vals)) {
      if (isset($vals['cardLog'])) {
        $this->cardLog = $vals['cardLog'];
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Thrift\Server\CardS2\CardLog();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PageCardLogs');
    if ($this->cardLog !== null) {
      if (!is_array($this->cardLog)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('cardLog', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->cardLog));
        {
          foreach ($this->cardLog as $iter20)
          {
