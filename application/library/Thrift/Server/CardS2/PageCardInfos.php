...
class PageCardInfos {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Thrift\Server\CardS2\CardInfo();
              $xfer += $elem12->read($input);
              $this->cardInfo []= $elem12;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PageCardInfos');
    if ($this->cardInfo !== null) {
      if (!is_array($this->cardInfo)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('cardInfo', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->cardInfo));
        {
          foreach ($this->cardInfo as $iter13)
          {
