...
class PageChargingOrders {
  static $_TSPEC;

  /**
   * @var \Thrift\Server\Charge\ChargingOrder[]
   */
  public $chargingOrders = null;
  /**
   * @var int
   */
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      if (isset($vals['chargingOrders'])) {
        $this->chargingOrders = $vals['chargingOrders'];
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Thrift\Server\Charge\ChargingOrder();
              $xfer += $elem5->read($input);
              $this->chargingOrders []= $elem5;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('PageChargingOrders');
    if ($this->chargingOrders !== null) {
      if (!is_array($this->chargingOrders)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('chargingOrders', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->chargingOrders));
        {
          foreach ($this->chargingOrders as $iter6)
          {
