...
interface CardCenterServiceIf {
  /**
   * @param \Thrift\Server\Card\Packages $packages
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function addPackage(\Thrift\Server\Card\Packages $packages);
  /**
   * @param \Thrift\Server\Card\Packages $packages
   * @param int $id
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function updatePackageByID(\Thrift\Server\Card\Packages $packages, $id);
  /**
   * @param int $id
   * @return \Thrift\Server\Card\Packages
   * @throws \Thrift\Server\Card\DataNotFoundException
   */
   ...
   * @return \Thrift\Server\Card\PagePackages
   * @throws \Thrift\Server\Card\DataNotFoundException
   */
  public function getPackageByPage($packageName, $pageSize, $currentPage);
  /**
   * @param \Thrift\Server\Card\Cards[] $cards
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function addCards(array $cards);
  /**
   * @param \Thrift\Server\Card\Cards $card
   * @param string $telephone
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function updateCardInfoByTel(\Thrift\Server\Card\Cards $card, $telephone);
  /**
   * @param \Thrift\Server\Card\Cards $card
   * @param string $ccID
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function updateCardInfoByCCID(\Thrift\Server\Card\Cards $card, $ccID);
  /**
   * @param int $packageID
   * @return \Thrift\Server\Card\Cards[]
   * @throws \Thrift\Server\Card\DataNotFoundException
   */
   ...
   * @param int $currentPage
   * @param string $packageName
   * @return \Thrift\Server\Card\PageCards
   * @throws \Thrift\Server\Card\DataNotFoundException
   */
  public function searchCardInfoByPage($ccid, $packageID, $produced_at, $telephone, $pageSize, $currentPage, $packageName);
  /**
   * @param \Thrift\Server\Card\Recharges $reCharge
   * @return string
   * @throws \Thrift\Server\Card\SaveOrUpdateException
   */
  public function addRecharge(\Thrift\Server\Card\Recharges $reCharge);
  /**
   * @param string $telephone
   * @return \Thrift\Server\Card\Recharges[]
   * @throws \Thrift\Server\Card\DataNotFoundException
   */
  public function getCardRechargeList($telephone);
}

class CardCenterServiceClient implements \Thrift\Server\Card\CardCenterServiceIf {
  ...
  public function send_addPackage(\Thrift\Server\Card\Packages $packages)
  {
    $args = new \Thrift\Server\Card\CardCenterService_addPackage_args();
  ...
  public function recv_addPackage()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_addPackage_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_addPackage_result();
  ...
  public function send_updatePackageByID(\Thrift\Server\Card\Packages $packages, $id)
  {
    $args = new \Thrift\Server\Card\CardCenterService_updatePackageByID_args();
    $args->packages = $packages;
    $args->id = $id;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_updatePackageByID_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_updatePackageByID_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_getPackageByID_args();
    $args->id = $id;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_getPackageByID_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_getPackageByID_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_getPackageByPackName_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_getPackageByPackName_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_getPackageByPackName_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_getAllPackage_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_getAllPackage_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_getAllPackage_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_getPackageByPage_args();
    $args->packageName = $packageName;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_getPackageByPage_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_getPackageByPage_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_addCards_args();
    $args->cards = $cards;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_addCards_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_addCards_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_updateCardInfoByTel(\Thrift\Server\Card\Cards $card, $telephone)
  {
    $args = new \Thrift\Server\Card\CardCenterService_updateCardInfoByTel_args();
    $args->card = $card;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_updateCardInfoByTel_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_updateCardInfoByTel_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_updateCardInfoByCCID(\Thrift\Server\Card\Cards $card, $ccID)
  {
    $args = new \Thrift\Server\Card\CardCenterService_updateCardInfoByCCID_args();
    $args->card = $card;
    $args->ccID = $ccID;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_updateCardInfoByCCID_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_updateCardInfoByCCID_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByPackageID_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByPackageID_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByPackageID_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByCCID_args();
    $args->ccID = $ccID;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByCCID_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByCCID_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByTel_args();
    $args->telephone = $telephone;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByTel_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByTel_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByStatus_args();
    $args->status = $status;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByStatus_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByStatus_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByTestStatus_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByTestStatus_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByTestStatus_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_searchCardInfoByPage_args();
    $args->ccid = $ccid;
    $args->packageID = $packageID;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_searchCardInfoByPage_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_searchCardInfoByPage_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_addRecharge(\Thrift\Server\Card\Recharges $reCharge)
  {
    $args = new \Thrift\Server\Card\CardCenterService_addRecharge_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_addRecharge_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_addRecharge_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Thrift\Server\Card\CardCenterService_getCardRechargeList_args();
    $args->telephone = $telephone;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Server\Card\CardCenterService_getCardRechargeList_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Server\Card\CardCenterService_getCardRechargeList_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->packages = new \Thrift\Server\Card\Packages();
...
class CardCenterService_addPackage_result {
  ...
  public $success = null;
  /**
   * @var \Thrift\Server\Card\SaveOrUpdateException
   */
  public $e = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'e',
          'type' => TType::STRUCT,
          'class' => '\Thrift\Server\Card\SaveOrUpdateException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->e = new \Thrift\Server\Card\SaveOrUpdateException();
...
class CardCenterService_getPackageByID_result {
  ...
  public $success = null;
  /**
   * @var \Thrift\Server\Card\DataNotFoundException
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'dataNotFound',
          'type' => TType::STRUCT,
          'class' => '\Thrift\Server\Card\DataNotFoundException',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Thrift\Server\Card\Packages();
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->dataNotFound = new \Thrift\Server\Card\DataNotFoundException();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Thrift\Server\Card\Packages();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \Thrift\Server\Card\Packages();
...
class CardCenterService_getPackageByPage_result {
  ...
  /**
   * @var \Thrift\Server\Card\PagePackages
   */
  public $success = null;
  /**
   * @var \Thrift\Server\Card\DataNotFoundException
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\Thrift\Server\Card\PagePackages',
          ),
        1 => array(
          'var' => 'dataNotFound',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Thrift\Server\Card\PagePackages();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem33 = null;
              $elem33 = new \Thrift\Server\Card\Cards();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->card = new \Thrift\Server\Card\Cards();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \Thrift\Server\Card\Cards();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Thrift\Server\Card\Cards();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem47 = null;
              $elem47 = new \Thrift\Server\Card\Cards();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem54 = null;
              $elem54 = new \Thrift\Server\Card\Cards();
...
class CardCenterService_searchCardInfoByPage_result {
  ...
  /**
   * @var \Thrift\Server\Card\PageCards
   */
  public $success = null;
  /**
   * @var \Thrift\Server\Card\DataNotFoundException
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\Thrift\Server\Card\PageCards',
          ),
        1 => array(
          'var' => 'dataNotFound',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Thrift\Server\Card\PageCards();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class CardCenterService_addRecharge_args {
  ...
  /**
   * @var \Thrift\Server\Card\Recharges
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        -1 => array(
          'var' => 'reCharge',
          'type' => TType::STRUCT,
          'class' => '\Thrift\Server\Card\Recharges',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case -1:
          if ($ftype == TType::STRUCT) {
            $this->reCharge = new \Thrift\Server\Card\Recharges();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem61 = null;
              $elem61 = new \Thrift\Server\Card\Recharges();
