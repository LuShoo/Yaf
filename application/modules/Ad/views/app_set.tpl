                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul style="float: left;" class="breadcrumb">
                                ...
                                <li style="margin-bottom: 0px;"><a>修改应用</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                            -->
                        </div>
                    </div>     
                        ...
                        <div class="span12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>修改应用</h4>
                                </div>
                                <div class="widget-body form">
                                    <form class="form-horizontal" id="appForm" action="/ad/app/set.html" method="post">
                                     <input type="hidden" name="id" id="id" value={$list['id']}>
                                      <div class="control-group">
                                            <label class="control-label">应用标识</label>
                                            <div class="controls">
                                                 <input type="text" id="app_code" name="app_code"  value={$list['app_code']}>
                                         ...
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                                 <input type="text" id="app_name" name="app_name"  value={$list['app_name']}>
                                                 <span class="help-inline"></span>
                                            </div>
                                        </div>
                                          <div class="control-group">
	                                        ...
	                                        <div class="controls">
	                                           <select  name="platform" id="platform">
												<option  {if $list['platform']=='iphone'} selected {/if}  value="iphone">iphone</option>
												<option  {if $list['platform']=='ipad'} selected {/if}  value="ipad">ipad</option>
												<option  {if $list['platform']=='anroid'} selected {/if}  value="anroid">anroid</option>
												<option  {if $list['platform']=='showboom'} selected {/if}  value="showboom">showboom</option>
												<option  {if $list['platform']=='pc'} selected {/if}  value="pc">pc</option>
												<option  {if $list['platform']=='mobileweb'} selected {/if}  value="mobileweb">mobileweb</option>
												</select>
	                                         </div>
	                                    </div>
                                       <div class="control-group">
