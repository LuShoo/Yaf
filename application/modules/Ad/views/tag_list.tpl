								...
								<div class="control-group form-horizontal search">
									<div class="row-fluid">
										...
										<div class="span8">
											...
											<div class="span2">
											<a href="/ad/tag/addview.html" title="添加tag" alt="添加tag"
											class="btn btn-primary" >添加tag</a>
									</div>
									</div>
								</div>
