                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul style="float: left;" class="breadcrumb">
                                ...
                                <li style="margin-bottom: 0px;"><a>添加tag</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                            -->
                        </div>
                    </div>     
                        ...
                        <div class="span12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>添加tag</h4>
                                </div>
                                <div class="widget-body form">
                                    <form class="form-horizontal" id="tagForm" action="/ad/tag/add.html" method="post">
                                           <div class="control-group">
	                                        <label class="control-label">应用id</label>
	                                        <div class="controls">
	                                           <select  name="app_id" id="app_id">
												{loop $list $key $row}
													<option  value="{$row['id']}">{$row['app_name']}</option>
												{/loop}
												</select>
	                                         </div>
	                                    </div>
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                                 <input type="text" id="tag_code" name="tag_code" >
