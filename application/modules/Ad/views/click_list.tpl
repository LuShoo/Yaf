							...
							<div class="widget-body">
								<div class="control-group form-horizontal search">
									<div class="row-fluid">
										...
										<div class="span8">
											时间: <input class="datepicker" style="width: 130px;"
