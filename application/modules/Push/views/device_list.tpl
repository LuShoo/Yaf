                                ...
                                <div class="modal-body" style="text-align: center;">
                                    <div id="uniform-fileInput">
                                        <form target="upload-form-iframe" id="upload-form"
                                              action="/push/device/importDataFromExcel.html" method="post"
                                        ...
                                        <a href="{STATIC_SERVER}/templ/ort.xlsx">点击下载导入模版</a>
                                    </div>
                                </div>
									...
									<div class="row-fluid">
										...
										<div class="span8">
											<input style="width: 100px;" style="color:#999999;"
												type="text" id="imei" name="imei"  alt="imei" title="imei" value="imei" default_val="imei"/>
                                            ...
                                            <a id="search-btn" class="btn btn-primary"
...
<script>
        ...
        $(function () {
            $.vpage({
            	  'uri': '/push/device/getDeviceList.html'
            });
			var _imei = $("#imei");
			var _mac = $("#mac");
			var _status = $("#status");
        ...
        function alertResult(data) {
            ...
            if(jsonData.code == 200){
                ...
                window.location.href = "/push/device/index.html";
