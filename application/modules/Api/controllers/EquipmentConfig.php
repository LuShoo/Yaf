 ...
 *  @final 2015-12-09
 */
class EquipmentConfigController extends Yaf_Controller_Abstract
{
	...
	public function indexAction()
	{
		...
		$total=TZ_Loader::service('Config','Api')->getEquipmenetConfigTotal($condition);
		if($total==0){
			throw new Exception('当前用户还没有设备。');
		}
		$result=TZ_Loader::service('Config','Api')->getEquipmenetConfigList($condition, $limit, $size);
