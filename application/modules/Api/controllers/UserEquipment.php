 ...
 *  @final 2015-12-09
 */
class UserEquipmentController extends Yaf_Controller_Abstract
{
	...
	public function indexAction()
	{
		...
		$limit = ($page-1)*$size;
		$total=TZ_Loader::service('Equipment','Api')->getUserEquipmenetTotal($condition);
		if($total==0){
			throw new Exception('当前用户还没有设备。');
		}
		$result=TZ_Loader::service('Equipment','Api')->getUserEquipmenetList($condition, $limit, $size);
