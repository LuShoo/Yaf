 ...
 *  @final 2016-04-06
 */
class ApnSetController extends Yaf_Controller_Abstract
{
...
//		}
		if(!isset($params["apn_type"])||empty($params["apn_type"])){
		...
		TZ_Loader::service('Apn','Api')->setApn($data,array('id:eq'=>$params["id"],'agent_id:eq'=>$params["agent_id"]));
