...
<body class="fixed-top">
                        ...
                        <div class="row-fluid" style="margin-top:10px; width: 30%; float:right;;margin-right: 20px;">
                            <div class="span12">
                                <div id="nestable_list_menu" class="margin-bottom-10 pull-right">
									<a href="javascript:void(0);" title="导出激活码" alt="导出激活码"
									   class="btn btn-primary" id="fileOutput">导出激活码</a>
                                ...
                                <div class="modal-body" style="text-align: center;">
                                    <div id="uniform-fileInput">
                                        <form target="upload-form-iframe" id="upload-form"
                                              action="/card/cardinfo/importDataFromExcel.html" method="post"
                                        ...
                                        <a href="{STATIC_SERVER}/templ/NewCardImport.xlsx">点击下载导入模版</a>
                                    </div>
                                </div>
								...
								<div class="modal-body" style="text-align: center;">
									<div id="uniform-fileInput">
										<form target="upload-form-iframe" id="download-form"
											  action="/card/cardinfo/exportData.html" method="post"
											  enctype="multipart/form-data">
											<div>
								...
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th>备注</th>
											<th>激活码&nbsp;<img id="cid_tag" src="/static/img/help.jpg" style="width:15px;height:15px;" /></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody id="list-data">
	...
	<script>
        ...
        $(function () {
            $.vpage({
            	  'uri': '/card/cardinfo/getlist.html'
            });
            var _iccid = $("#iccid");
            ...
            var _batch = $("#batch");
             ...
             var _list = [_iccid,_telephone,_batch,_startTime,_endTime];
             //循环绑定事件 
             ...
             $("#search-btn").click(function(e) {
                 ...
                 $.vpage({
                	 'uri': '/card/cardinfo/getlist.html',
                     'query':  "&iccid="+iccid+'&telephone='+telephone+"&batch="+batch+"&status="+status+"&start_time="+startTime+"&end_time="+endTime
                 });
             });
			$('#exportData').click(function() {
				...
				var startTime = (_startTime.val()==_startTime.attr('default_val')) ? '' : _startTime.val();
				var endTime = (_endTime.val()==_endTime.attr('default_val')) ? '' : _endTime.val()+' 23:59:59';
				window.open("/card/cardinfo/exportDatatwo.html?iccid="+iccid+'&telephone='+telephone+"&batch="+batch+"&status="+status+"&start_time="+startTime+"&end_time="+endTime);
			});
        });
		...
		function alertResult(data) {
			...
			window.location.href = "/card/cardinfo/index.html";
		}
