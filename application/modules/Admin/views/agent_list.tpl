                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <ul class="breadcrumb" style="float: left;">
                            ...
                            <li style="margin-bottom: 0px;"><a href="#">客户管理</a><span class="divider">&nbsp;</span></li>
                            <li style="margin-bottom: 0px;"><a href="/admin/agent/index.html">客户信息管理</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
                        ...
                        <div class="row-fluid" style="margin-top:10px; width: 10%; float:right; margin-right: 20px;">
                            <div class="span12">
                                <div id="nestable_list_menu" class="margin-bottom-10 pull-right">
                                    <a href="/admin/agent/add.html" data-action="expand-all" class="btn btn-info" type="button">添加大客户</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>大客户列表</h4>
                            </div>
