...
<body class="fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <!--
                        <h3 class="page-title">
                            渠道管理<small>渠道卡列表</small>
                        </h3>
                        <ul class="breadcrumb" style="float: left;">
                            <li style="margin-bottom: 0px;"><a href="/admin/home/index.html"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li style="margin-bottom: 0px;"><a href="/admin/user/index.html">渠道卡列表</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
                        -->
								...
								<div class="modal-body" style="text-align: center;">
									<div id="uniform-fileInput">
										<form target="upload-form-iframe" id="upload-form"
											action="/admin/channelcard/importDataFromExcel.html" method="post"
                                ...
                                <div class="modal-body" style="text-align: center;">
                                    <div id="uniform-fileInput">
                                        <form target="upload-form-iframe" id="upload-form_edit"
                                              action="/admin/channelcard/editDataFromExcel.html" method="post"
                                              enctype="multipart/form-data">
                                            <div>
                                    ...
                                    <thead>
                                        <tr>
                                           <!-- <th>ID</th>-->
                                            ...
                                            <th>流量卡类型</th>
                                            <th>手机号</th>
                                            <th>出库批次号&nbsp;<img id="batch_img" src="/static/img/help.jpg" style="width:15px;height:15px;" /></th>
                                            <th>SIM卡激活状态</th>
                                            <th>店员绑定状态</th>
                                            <th>充值状态</th>
                                            <th>渠道号</th>
    ...
    <script>
        ...
        $(function () {
            $.vpage({
                'uri': '/admin/channelcard/getlist.html'
            });
            var _iccid = $("#iccid");
            var _cid = $("#cid");
           ...
           // var _is_binding = $("#is_binding");
             ...
             var _list = [_iccid,_cid,_startTime,_endTime];
             //循环绑定事件
             ...
             $("#search-btn").click(function(e) {
                 ...
                 $.vpage({
                	 'uri': '/admin/channelcard/getlist.html',
                     'query': "&iccid="+iccid+ "&cid="+cid+"&is_active="+is_active+'&is_binding='+is_binding+"&is_recharge="+is_recharge+"&start_time="+startTime+"&end_time="+endTime
                 });
             });
            ...
            $('#exportData').click(function() {
                ...
                window.open("/admin/channelcard/exportData.html?iccid="+iccid+ "&cid="+cid+"&is_active="+is_active+'&is_binding='+is_binding+"&is_recharge="+is_recharge+"&start_time="+startTime+"&end_time="+endTime);
        ...
        function delConfig(id){
			$.delDiv({
				...
				type:'post',
				url:'/admin/channelcard/delConfig.html',		//回调url
				returnUrl:'/admin/channelcard/index.html'		//删除成功后跳转的url
			});
           }
    	...
    	function alertResult(data) {
            ...
            if(jsonData.code == 200){
                     ...
                     window.location.href = "/admin/channelcard/index.html";
