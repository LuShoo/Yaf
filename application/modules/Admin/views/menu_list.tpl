                        ...
                        <div class="row-fluid" style="margin-top:10px; width: 10%; float:right;;margin-right: 20px;">
                            <div class="span12">
                                <div id="nestable_list_menu" class="margin-bottom-10 pull-right">
                                    <a href="/admin/home/addmenu.html" data-action="expand-all" class="btn btn-info" type="button">新增菜单</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <!--{loop $list $val}-->
                                        <tr class="odd">
                                            ...
                                            <td width="8%">&nbsp;{$val['pid']}</td>
                                            <td width="12%">&nbsp;{$val['name']}</td>
                                            <td width="22%">&nbsp;{$val['action']}</td>
                                            <td width="16%">&nbsp;{$val['icon']}</td>
                                            <td width="16%">&nbsp;{$val['created_at']}</td>
                                            <td width="6%">{if $val['status'] == 1}正常{else}隐藏{/if}</td>
                                            <td width="12%">
                                                <a href="/admin/home/editmenu.html?id={$val['id']}" class="btn btn-small btn-primary">编辑</a>
                                                <a href="/admin/home/delmenu.html?id={$val['id']}" class="btn btn-small btn-danger">删除</a>
                                            </td>
                                        </tr>
                                    <!--{/loop}-->
                                    </tbody>
