<div id="footer">
    Powered by <a href="http://x.747.cn">黑米技术团队</a> © <a href="javascript:void(0);" id="xiubao"> 秀豹 </a>
    <div class="up" id="goTopBtn" style="float:right;display:none;">
        <img border="0" src="{STATIC_SERVER}/img/top.png">
    </div>
</div>
<!--
<div id="footer">
...
<script type="text/javascript" src="/static/js/jquery_vpage.js?v={STATIC_VERSION}"></script>
 ...
 <script type="text/javascript" src="/static/assets/dtree/js/jquery.ztree.core.js"></script>
 <script type="text/javascript" src="/static/assets/dtree/js/jquery.ztree.excheck.js"></script>
 <script type="text/javascript" src="/static/js/bootstrapQ.min.js"></script>
<script>
...
//		menuObj.prev().children('span[class="arrow"]').addClass('open');
        ...
        jQuery('#xiubao').append("<span>"+year+"</span>");
    });
