            ...
            <div class="span12">
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  ...
                  <a href="/app/app/addApp.html" data-action="expand-all" class="btn btn-info" type="button">添加经销商</a><br/><br>
    ...
    <script>
      ...
      $(function() {
        ...
        $('#start-del').click(function() {
          ...
          $.post('/app/app/delApp.html', data, function(r) {
            if (r.detail == 'ok') {
              $('.dialog-upload-card').hide();
              alert("操作成功。");
        ...
        $('#exportData').click(function() {
          ...
          var startTime = (_startTime.val() == _startTime.attr('default_val')) ? '' : _startTime.val();
          var endTime = (_endTime.val() == _endTime.attr('default_val')) ? '' : _endTime.val() + ' 23:59:59';
          window.open("/device/device/exportData.html?mac=" + mac + "&imei=" + imei + '&status=' + status + '&start_time=' + startTime + '&end_time=' + endTime);
        });
        */
      });
