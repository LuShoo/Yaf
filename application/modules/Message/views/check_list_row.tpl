...
<tr class="odd">
	...
	<td width="22%">
	{if $msg_info['audit_status'] == 1}
		<a href="javascript:void(0);" class="btn btn-small btn-default" disabled="disabled" data-id="{$msg_info['id']}">审核</a>
	{else}
		<a href="javascript:void(0);" class="btn btn-small btn-primary checkMsg" disabled="disabled" data-id="{$msg_info['id']}">审核</a>
