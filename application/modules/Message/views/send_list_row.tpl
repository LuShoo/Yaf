...
<tr class="odd">
	...
	<td width="22%">
		...
		<a href="javascript:void(0);" class="btn btn-small btn-primary sendMsgr" datas-id="{$msg_info['id']}">重发</a>
		<a href="javascript:void(0);" class="btn btn-small btn-primary sendMsgy" datay-id="{$msg_info['id']}">预览</a>
	</td>
</tr>
{/loop}
