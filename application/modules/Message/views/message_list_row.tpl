...
<tr class="odd">
	...
	<td width="22%">
		<a href="/message/message/editMsg.html?id={$msg_info['id']}" class="btn btn-small btn-primary">编辑</a>
		<a href="javascript:void(0);" class="btn btn-small btn-primary deleteMsg" data-id="{$msg_info['id']}">删除</a>
	</td>
</tr>
{/loop}
