...
<body class="fixed-top">
              ...
              <div class="widget-body form">
                ...
                <form class="form-horizontal">
                  ...
                  <div class="control-group hidden" id="msgtags">
                    ...
                    <div class="controls">
                      <input class="span6 popovers" name="tags" onclick="showTagList(this)" type="text" value="{$msginfo['tags']}" data-original-title="提示" data-content="点击选择标签" data-trigger="hover" readonly="readonly" style="cursor: pointer;" />
                    </div>
                  </div>
  ...
  <div class="modal fade" id="selectTag" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="sendtags" onclick="onCheck()">Save changes</button>
            </div>
        </div>
    </div>
  </div>
  <script>
    ...
    $(function(){
      ...
      var scope = $("input[name='scope']:checked").val().trim();
    ...
    function zTreeOnCheck(event, treeId, treeNode) {
      ...
      if(treeNode.checked){
        for(var i in cNodes) {
          ztreeObj.setChkDisabled(cNodes[i],true,false,true);
          ztreeObj.updateNode(cNodes[i])
        }
      } else {
        for(var i in cNodes) {
          ztreeObj.setChkDisabled(cNodes[i],false,false,true);
